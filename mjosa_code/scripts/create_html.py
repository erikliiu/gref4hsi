...
# Add mjosa_code to path to import config
...
if __name__ == "__main__":
    ...
    HSI_DIR = config.OUTPUT_FOLDER  # Georeferenced H5 files (from processing output)

    # Output in same folder as this script
    ...
    build_map_with_mbes(
        ...
        vmax=None,
        legend_caption="MBES (depth, m)",
        # HSI via folder (georeferenced H5 files from processing output)
        hsi_h5_dir=HSI_DIR,
