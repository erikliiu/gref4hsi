...
DATA_DIR = os.path.join(
    base_fp, "HyperspectralDataAll/UHI/2020-07-01-14-34-57-ArcticSeaIce-Ben-Lange/"
)
...
config_path_template = os.path.join(
    home, "VsCodeProjects/gref4hsi/data/config_examples/configuration_uhi.ini"
)
...
custom_config = {
    "General": {
        ...
        "max_ray_length": 5,
        "lab_cal_dir": os.path.join(
            base_fp, "HyperspectralDataAll/UHI/Lab_Calibration_Data/NP"
        ),
    },  # Max distance in meters from UHI to seafloor
    "Coordinate Reference Systems": {
        ...
        "pos_epsg_orig": 4978,
    },  # The CRS of the positioning data we deliver to the georeferencing
    "Relative Paths": {
        "dem_folder": "Input/GIS/"
    },  # Using altimeter, we generate one DEM per transect chunk
    "Absolute Paths": {
        "geoid_path": os.path.join(
            home, "VsCodeProjects/gref4hsi/data/world/geoids/egm08_25.gtx"
        )
    },  # Using altimeter, we generate one DEM per transect chunk
    "Orthorectification": {
